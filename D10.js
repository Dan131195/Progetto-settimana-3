...
console.log(isThisAnEmail("daniele@franceschini.com"));
...
function whatDayIsIt() {
  ...
  let dayName = daysName[dayNumber];
  return dayName;
}
...
let yesterday = new Date(2024, 10, 14);

function howManyDays(date) {
  let today = new Date();
  let sum = Math.floor((today - date) / 1000 / 60 / 60 / 24);
  return sum;
}
...
const myBirthday = new Date(2024, 10, 15);
const dayBirthday = myBirthday.getDate();
const monthBirthday = myBirthday.getMonth();

function isTodayMyBirthday() {
  let today = new Date(2024, 10, 15);
  let dayToday = today.getDate();
  let monthToday = today.getMonth();
  if (dayBirthday === dayToday && monthBirthday === monthToday) {
    return true;
  } else {
    return false;
  }
...
function searchByTitle(title) {
  return movies.filter((element) => element.Title.includes(title));
}
...
function one() {
  const number1 = document.getElementById("container");
}
...
function two() {
  const number2 = document.querySelectorAll("td");
}
...
function four() {
  const number4 = document.querySelectorAll("a");
...
function five() {
  const number5 = document.getElementById("myList");
  number5.innerHTML += "<li>4</li>";
}
...
function six() {
  const number6 = document.getElementById("myList");
  number6.remove();
}
...
function seven() {
  const number8 = document.querySelectorAll("tr");
